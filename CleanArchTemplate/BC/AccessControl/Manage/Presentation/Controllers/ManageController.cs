...
using CleanArchTemplate.BC.AccessControl.Manage.Presentation.ViewModels;
//using CleanArchTemplate.BC.AccessControl.Manage.Domain.Models;

// Remove following dependency
using CleanArchTemplate.BC.AccessControl.Account.Presentation.Controllers;
...
namespace CleanArchTemplate.BC.AccessControl.Manage.Presentation.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> EnableTwoFactorAuthentication()
        {
            ...
            return RedirectToAction("Index", "Manage", new { area = "Manage" });
        }
